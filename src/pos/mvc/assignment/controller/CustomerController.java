...
public class CustomerController {
    ...
    public ArrayList<CustomerModel> getAllCustomer() throws SQLException{
        ...
        while(rst.next()){
            CustomerModel cm = new CustomerModel(rst.getString(1), rst.getString(2), rst.getString(3), rst.getString(4), rst.getDouble(5), rst.getString(6), rst.getString(7), rst.getString(8), rst.getString(9));
    ...
    public String updateCustomer(CustomerModel customerModel) throws SQLException{
        ...
        preparedStatement.setString(8, customerModel.getZipcode());
